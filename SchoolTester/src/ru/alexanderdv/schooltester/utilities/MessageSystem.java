...
public class MessageSystem
{
	...
	static
	{
		messages.put("ru_ru", new HashMap<String, String>());
		{
			...
			messages.get(language).put("images", "изображения");
			...
			messages.get(language).put("randomizeBlocks", "рандомизироватьБлоки");
			messages.get(language).put("randomizeGroups", "рандомизироватьГруппы");
